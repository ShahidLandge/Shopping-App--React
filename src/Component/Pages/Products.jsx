    ...
    function highToLow(){
      ...
      return (
        <div className="App">
          ...
          <button className="filterButton" onClick={()=>searchProduct()}>Fetch </button>
        <button className="filterButton" onClick={()=>lowToHigh()} >Low-to-High Price  </button>
        <button className="filterButton" onClick={()=>highToLow()} >High-to-Low Price </button>
        <br/>
        <br/>
        <br/>
